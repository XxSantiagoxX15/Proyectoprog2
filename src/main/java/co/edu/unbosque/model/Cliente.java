...
public class Cliente {
	...
	public Cliente(int id,String nombre,String apellido, String email,String telefono,String direccion,String user_password,boolean frecuente,Date fecha_registro,boolean cta_bloqueada) {
	this.id=id;
	this.nombre=nombre;
