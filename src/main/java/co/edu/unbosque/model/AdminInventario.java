...
public void correo(String correo, String accion, String nombre,String subject) {
	...
	public boolean ingresarinv(CompraInventarioDTO dto) {
		...
		correo(usuarioCorreo,accion,usuarioCorreo+" Y se ingreso el producto"+daoproducto.findOne(dto.getProducto()).getNombre()+"con cantidad de "+dto.getCantidad_adquirida(),subject);
