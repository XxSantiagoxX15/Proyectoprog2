...
/**
 * This class contains unit tests for the ShopysApplication class.
 */
public class ShopysApplicationTests {
	...
	public void testCrearUser() {
		...
		UserDTO userdto = new UserDTO(1018323, "Santiago", "melo", "Santiagomelo15@hotmail.com",
				user.encryptPassword("Santiago34*"), true, false);
